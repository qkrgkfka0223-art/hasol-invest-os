...
def load_biotech_fda_seed_candidates() -> pd.DataFrame:
    ...
    rows = [
        ...
        ("APLS", "Apellis Pharmaceuticals", "ophthalmology/complement FDA catalyst watch"),
        ("IMVT", "Immunovant", "autoimmune clinical catalyst watch"),
        ("EXEL", "Exelixis", "oncology label/earnings catalyst watch"),
        ("INCY", "Incyte", "oncology/immunology pipeline catalyst watch"),
        ("NBIX", "Neurocrine Biosciences", "CNS commercial/FDA catalyst watch"),
    ]
    return pd.DataFrame([
        {
            "ticker": t,
